...
- **병렬 비교 (Side-by-Side Comparison)**: 두 이미지를 동시에 나란히 띄워놓고 비교합니다.
- **차이점 강조 (Difference Highlighting)**: 두 이미지 간의 차이점을 자동으로 감지하고 강조 표시합니다.

    (PDF 문서는 Tiff(multiple page 형식) 로 변환하여 사용합니다)
